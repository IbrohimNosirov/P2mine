...
sph.x: sph.o params.o state.o binhash.o interact.o leapfrog.o io_txt.o timing_harness.o
	$(CPP) $(CPPFLAGS) $^ -o $@ $(LIBS)

sph.o: sph.cpp params.hpp state.hpp binhash.hpp interact.hpp leapfrog.hpp io.hpp timing_harness.hpp
...
timing_harness.o: timing_harness.cpp timing_harness.hpp
...
codes.tex: params.hpp state.hpp interact.cpp binhash.hpp zmorton.hpp binhash.cpp \
		leapfrog.cpp sph.cpp params.cpp io_txt.cpp timing_harness.cpp timing_harness.hpp
	dsbweb -o $@ -c $^
